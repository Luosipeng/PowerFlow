...
# 获取所有节点的电压结果
voltage_results = PowerFlow.get_bus_voltage_results(results, new_case)

# 比较结果与参考文件
# result_file = joinpath(pwd(), "data", "etap_runpf_result.xlsx")
# result_file = "C:/Users/13733/Desktop/石桥F12草河F27result.xlsx"
# result_file = joinpath(pwd(), "data", "石桥F12草河F27连接result.xlsx")
result_file = joinpath(pwd(), "data", "交流光伏系统测试结果.xlsx")
